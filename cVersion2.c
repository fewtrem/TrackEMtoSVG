...
* */
double * doCirc(double perpDir[3],double dirCirc[3],double centrePoint[3], uint8_t * outputImgP,int outputSize[3],double rotAmount,double radius,double incAmount){
	static double vectOut[6];
...
double * addSphere(double centrePoint[3], uint8_t * outputImgP,int outputSize[3],double rotAmount,double radius,double incAmount){
	static double vectOut[6];
	uint8_t * outputImg = (uint8_t *) outputImgP;
